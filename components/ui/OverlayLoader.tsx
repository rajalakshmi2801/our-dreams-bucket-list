...
interface Props {
  fullPage?: boolean; // true = initial page load (solid bg), false = action overlay (blur)
}

export default function OverlayLoader({ fullPage = false }: Props) {
  if (fullPage) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-rose-50 via-white to-purple-50 flex items-center justify-center">
